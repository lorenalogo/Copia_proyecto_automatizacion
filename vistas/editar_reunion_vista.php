                            ...
                            <form role="form" name="editar-reunion" id="editar-reunion" method="post" action="../Modelos/modelo_reunion.php">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required minlength="4" value="<?php echo $estado['lugar']; ?>" style="width: 90%;" type="text" class="form-control" id="lugar" name="lugar" placeholder="Lugar donde se dearrollara la Reunion">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea required minlength="4"  class="form-control" id="asunto" name="asunto" rows="3" placeholder="Ingrese el asunto de la Reunión"><?php echo $estado['asunto']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="agenda">Agenda Propuesta</label>
                                    <textarea required minlength="10" class="form-control" id="agenda" name="agenda" rows="13" placeholder="Ingrese Agenda Propuesta"><?php echo $estado['agenda_propuesta']; ?></textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
