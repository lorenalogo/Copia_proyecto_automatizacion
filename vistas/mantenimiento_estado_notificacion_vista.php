...
{
    $_SESSION['btn_nuevo_estado_notificacion']="";
    }
    else
    {
        $_SESSION['btn_nuevo_estado_notificacion']="disabled";
    }
                                            ...
                                            <tbody>
                                                ...
                                                while ($estadonotificacion = $resultado->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../vistas/editar_estadonotificacion_vista.php?id=<?php echo $estadonotificacion['id_estado_notificacion'] ?>" class="btn btn-success <?php echo $_SESSION['btn_editar'];?>" style="color: while;">
                                                                Editar
                                                            </a>
                                                            <a href="#" data-id="<?php echo $estadonotificacion['id_estado_notificacion']; ?>" data-tipo="manestadonotificacion" class="borrar_estadonotificacion btn btn-danger <?php echo $_SESSION['btn_borrar'];?>">
                                                                Borrar
                                                            </a>
                                                        </td>
                                                    </tr>
